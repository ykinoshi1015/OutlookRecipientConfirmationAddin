...
* setup.zipをクリックし、Downloadボタンを押します  
...
* setup.zipがダウンロードされるので、展開し、setup.batを管理者として実行します  
...
* デスクトップ版 Outlook2016を起動すると（すでに開いている場合は再度開きなおす）、アドインが有効になります  


## お問い合わせ

バグや、改善点などのご意見がありましたら、  
*どうする？？？
